...
export function FloatingPathsBackground({
  ...
  const paths = Array.from({ length: 58 }, (_, index) => {
    ...
    return {
      id: index,
      // Preserve the original curve, then continue it smoothly beyond the
      // right edge so its endpoint never appears as a cutoff on screen.
      d: `M-${260 + offset * bend} ${120 + offset} C ${220 + offset * bend} ${20 - offset} ${420 - offset * bend} ${480 + offset} ${980 + offset * bend} ${180 + offset} S ${1680 + offset * bend} ${80 + offset} ${2300 + offset * bend} ${180 + offset}`,
